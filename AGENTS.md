...
cc-journal is a Go CLI tool that auto-summarizes Codex sessions into a developer journal. It parses JSONL transcripts, generates AI summaries via the Anthropic API, and serves a web dashboard.
...
- Journal entries stored as markdown in `~/Codex-journal/YYYY-MM-DD.md`
